        ...
        <div class="row justify-content-between">
          <div class="col-lg-4 mb-5 mb-lg-0">
            ...
            <p data-aos="fade-up" data-aos-delay="100">
              Deshbhakt Ratnappa Kumbhar Highschool has a best Education. We
              promote rich and Indian cultural heritage and
              integrate it with
              modern education. This broadens the students horizon of knowledge.
              It enables them to develop into a
              complete and balanced personality..</p>
        ...
        <div class="row justify-content-between">
          <div class="col-lg-5 mb-5">
            ...
            <p data-aos="fade-up" data-aos-delay="100">Far far away, behind the
              ...
              they live in Bookmarksgrove right at the
              coast of the Semantics, a large language ocean.</p>
            <ul class="list-unstyled ul-check mb-5 primary" data-aos="fade-up"
              data-aos-delay="200">
              ...
              <div class="accordion-item">
                <h2 class="mb-0">
                  <button class="btn btn-link collapsed" type="button"
                    ...
                    aria-expanded="false" aria-controls="collapseTwo">We Value
              ...
              <div class="accordion-item">
                <h2 class="mb-0">
                  <button class="btn btn-link collapsed" type="button"
                    ...
                    aria-expanded="false" aria-controls="collapseThree">Your
                    ...
                    <div class="d-flex">
                      ...
                      <div>
                        <p>When she reached the first hills of the Italic
                          ...
                          skyline of her hometown Bookmarksgrove, the headline
                          of Alphabet Village and the subline of her
                          own road, the Line Lane.</p>
                        <p>Pityful a rethoric question ran over her cheek, then
